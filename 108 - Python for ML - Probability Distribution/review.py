...
Per30_size = int(len(song_tempos) * 30 / 100)
print(len(song_tempos), Per30_size)
sampling_distribution(song_tempos, Per30_size, 'Mean')
# task 8: sampling distribution of the sample minimum
sampling_distribution(song_tempos, Per30_size, 'Minimum')
# task 10: sampling distribution of the sample variance
sampling_distribution(song_tempos, Per30_size, 'Variance')
...
standard_error = population_std / (Per30_size ** .5)
