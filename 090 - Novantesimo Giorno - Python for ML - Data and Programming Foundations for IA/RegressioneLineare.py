...
possible_bs = [bs/10 for bs in range(-200, 201)]
...
for m in possible_ms:
  for b in possible_bs:
      calculated_error = calculate_all_error(m, b, datapoints)
      if smallest_error > calculated_error:
        smallest_error = calculated_error
        best_m = m
        best_b = b
...
# La predizione dice che con una pallina da 6cm rimbalzerà 4cm
