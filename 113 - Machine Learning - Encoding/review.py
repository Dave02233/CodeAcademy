...
reviews = reviews.join(one_hot).drop('department_name', axis=1)
...
#diventa un array numPy, si può creare un df con reviews = pd.DataFrame(reviews, columns=original_column_names, index=original_index)
